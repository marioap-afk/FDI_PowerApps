...
| `N3B` Adjuntar archivos | Criterios para configuración de niveles | Adjuntos existentes de cotización | `N3` = Sí | Adjuntos de `Cotizaciones 2026` | N/A | No se crea columna nueva. |
