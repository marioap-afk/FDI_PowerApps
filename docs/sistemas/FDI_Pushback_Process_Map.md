...
| `B` Método de captura | Método de captura | Dropdown | Siempre en Pushback | Requerida `Tipo de diseño`; `PayloadSistemaJson.MetodoCaptura` | `colPBK_Draft` | Opciones: `Diseño`, `Listado de piezas`, `Cotización o pedido anterior`. | Controla secciones visibles. |
