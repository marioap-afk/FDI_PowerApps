...
| `B` Método de captura | Método de captura | Dropdown | Siempre en Drive In | Requerida `Tipo de diseño`; `PayloadSistemaJson.MetodoCaptura` | `colDRV_Draft` | Opciones: `Diseño`, `Listado de piezas`, `Cotización o pedido anterior`. | Controla secciones visibles. |
