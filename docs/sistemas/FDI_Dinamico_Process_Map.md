...
| `B` Método de captura | Método de captura | Dropdown | Siempre en Dinamico | Requerida `Tipo de diseño`; `PayloadSistemaJson.MetodoCaptura` | `colDIN_Draft` | Opciones: `Diseño`, `Listado de piezas`, `Cotización o pedido anterior`. | Controla secciones visibles. |
